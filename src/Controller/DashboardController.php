...
class DashboardController extends Controller
{
    ...
    public function index(Request $request, UserInterface $user = null, LoggerInterface $logger)
    {
        ...
        // Edit Data
        if ($form->isSubmitted() && $form->isValid() && $form->getClickedButton() && 'edit' === $form->getClickedButton()->getName()) {
            $reservationId = $form->get('reservationId')->getData();
            $roomReservations = $entityManager->getRepository(RoomReservation::class)->find($reservationId);
